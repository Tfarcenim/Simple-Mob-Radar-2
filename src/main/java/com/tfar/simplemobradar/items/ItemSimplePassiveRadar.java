...
public class ItemSimplePassiveRadar extends Item implements IHasModel {
    ...
    public int getMobs(World Worldin, BlockPos pos, EntityPlayer player, EnumHand hand) {
        ...
        List<Entity> entities = Worldin.getEntitiesWithinAABB(Reference.animals.get(player.getHeldItem(hand).getTagCompound().getInteger("mobtype")).getEntityClass(), new AxisAlignedBB(x - r, y - r, z - r, x + r, y + r, z + r));
